...
class ImportCep
{
    ...
    public function __construct(ViaCep $viaCep, Country $country, State $state, City $city, Neighborhood $neighborhood, Address $address)
    {
        $this->http = $viaCep;
    ...
    private function httpViaCep(string $cep): bool
    {
        $uri = '/ws/##cep##/json/';
